...
function ParticipantTile({
  ...
  return (
    <div
      className={cn(
        "grid min-h-44 place-items-center gap-4 rounded-xl bg-secondary p-5 text-center",
        participant.isSpeaking && "bg-primary/15",
      )}
      data-testid="participant-tile"
      data-user-id={participant.userId}
      data-speaking={participant.isSpeaking}
      data-audio-published={hasAudio(participant)}
    >
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_21rem]">
        <Card className="min-h-[34rem]">
          ...
          <CardContent className="flex flex-1 flex-col gap-5">
              ...
              <div className="grid flex-1 place-items-center rounded-xl bg-secondary p-8 text-center">
                <div className="max-w-sm">
                  ...
                  <p className="mt-2 leading-6 text-muted-foreground">
                    Keep this page open. The join button will appear as soon as the room
                    goes live.
                  </p>
                </div>
              </div>
            ...
            {isLive && !room.is_host && !isJoined ? (
              <div className="grid flex-1 place-items-center rounded-xl bg-secondary p-8 text-center">
                <div className="max-w-sm">
                  ...
                  <p className="mt-2 leading-6 text-muted-foreground">
                    Join as a listener. Your microphone starts off and stays unavailable
                    until the host invites you to speak.
                  </p>
                  <Button
                    className="mt-6"
                    size="lg"
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 rounded-xl bg-secondary p-3">
              {room.is_host && isJoined ? (
                <Button
                  variant="secondary"
          ...
          <Card>
            ...
            <CardContent className="grid gap-4">
              <div className="flex items-center gap-3 rounded-lg bg-secondary p-3">
                ...
                {room.is_host ? <Check className="ml-auto size-4 text-[#23a559]" /> : null}
              </div>
              {!room.is_host ? (
                <div className="flex items-center gap-3 rounded-lg bg-secondary p-3">
                  ...
                  <Check className="ml-auto size-4 text-[#23a559]" />
                </div>
              ) : null}
            </CardContent>
          </Card>
